...
M.set_colors = function(colors)
	return {
		...
		Pmenu = { fg = colors.foreground, bg = colors.color8 },
		...
		CursorLine = { bg = colors.color8 },
		CursorColumn = { bg = colors.color8 },
		ColorColumn = { bg = colors.color8 },
		...
		-- Telescope
		TelescopeBorder = { fg = colors.color1, bg = colors.color8 },
		TelescopeNormal = { fg = colors.foreground, bg = colors.color8 },
		TelescopeSelection = { fg = colors.background, bg = colors.color1 },

		-- Indent Blank Line
		IndentBlanklineChar = { fg = colors.color1, bg = colors.color8 },

		-- NvimTree
		NvimTreeNormal = { fg = colors.foreground, bg = colors.color8 },
		NvimTreeNormalNC = { fg = colors.foreground, bg = colors.color8 },
		...
		-- LspSaga
		LspFloatWinNormal = { bg = colors.color8 },
		...
		BlinkCmpKindCodeium = { fg = colors.color7 },
		BlinkCmpKindNumber = { fg = colors.color5 },
		BlinkCmpSignatureHelpBorder = { fg = colors.color4 },
		BlinkCmpSignatureHelp = { fg = colors.foreground, bg = colors.color8 },
		BlinkCmpKindTabNine = { fg = colors.color6 },
		BlinkCmpKindKey = { fg = colors.color6 },
		BlinkCmpKindNamespace = { fg = colors.color7 },
		BlinkCmpKindArray = { fg = colors.color5 },
		BlinkCmpKindPackage = { fg = colors.color4 },
		BlinkCmpKindBoolean = { fg = colors.color5 },
		BlinkCmpKindSupermaven = { fg = colors.color6 },
		BlinkCmpKindCopilot = { fg = colors.color2 },
		BlinkCmpDocBorder = { fg = colors.color4, bg = colors.color8 },
		BlinkCmpKindObject = { fg = colors.color5 },
		BlinkCmpDoc = { fg = colors.foreground, bg = colors.color8 },
		BlinkCmpKindEnum = { fg = colors.color6 },
		BlinkCmpMenu = { fg = colors.foreground, bg = colors.color8 },
		BlinkCmpKindNull = { fg = colors.color11 },
		BlinkCmpKindString = { fg = colors.color12 },
		BlinkCmpGhostText = { fg = colors.color1 },
		BlinkCmpKindTypeParameter = { fg = colors.color6 },
		BlinkCmpKindStruct = { fg = colors.color6 },
		BlinkCmpKindConstant = { fg = colors.color5 },
		BlinkCmpKindEnumMember = { fg = colors.color6 },
		BlinkCmpKindFolder = { fg = colors.color4 },
		BlinkCmpKindFile = { fg = colors.color4 },
		BlinkCmpKindSnippet = { fg = colors.color3 },
		BlinkCmpKindColor = { fg = colors.color5 },
		BlinkCmpKindReference = { fg = colors.color5 },
		BlinkCmpKindEvent = { fg = colors.color6 },
		BlinkCmpKindKeyword = { fg = colors.color6 },
		BlinkCmpKindOperator = { fg = colors.color7 },
		BlinkCmpMenuBorder = { fg = colors.color4, bg = colors.color8 },
		BlinkCmpKindValue = { fg = colors.color5 },
		BlinkCmpKindProperty = { fg = colors.color4 },
		BlinkCmpKindModule = { fg = colors.color7 },
		BlinkCmpKindInterface = { fg = colors.color6 },
		BlinkCmpKindClass = { fg = colors.color6 },
		BlinkCmpKindField = { fg = colors.color12 },
		BlinkCmpKindUnit = { fg = colors.color5 },
		BlinkCmpKindConstructor = { fg = colors.color6 },
		BlinkCmpKindFunction = { fg = colors.color6 },
		BlinkCmpKindMethod = { fg = colors.color6 },
		BlinkCmpKindVariable = { fg = colors.color5 },
		BlinkCmpKindText = { fg = colors.foreground },
		BlinkCmpLabelMatch = { fg = colors.color7, bg = colors.color8 },
		BlinkCmpLabelDeprecated = { fg = colors.color2, bg = colors.color8 },
		BlinkCmpLabel = { fg = colors.foreground, bg = colors.color8 },
		...
		AvanteToBeDeleted = { fg = colors.foreground, bg = colors.color11 },
		...
		AvanteConflictCurrent = { bg = colors.color1 },
		AvanteConflictIncoming = { bg = colors.color4 },
